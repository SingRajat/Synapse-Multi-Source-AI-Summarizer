...
def refine_summaries(summaries: list[str],llm):
...
def generate_summary(docs: list[Document], api_key:str)->tuple[str, dict]:
    ...
    t2 = time.time()
    final_summary, reduce_in, reduce_out = refine_summaries(summaries,llm)
